        ...
        {!showConfirm ? (
          <>
            ...
            <Button
              variant="ghost"
              size="sm"
              className="h-9 w-9 p-0 rounded-xl hover:bg-emerald-50 text-emerald-600 hover:text-emerald-700"
              onClick={() => setModalConfig({ isOpen: true, actionType: 'SHARE', channel: 'WHATSAPP' })}
            ...
            <Button
              variant="ghost"
              size="sm"
              className="h-9 w-9 p-0 rounded-xl hover:bg-slate-100 text-slate-400 hover:text-slate-700"
