              ...
              <div>
                ...
                <div className="relative">
                  <input
                    type="date"
                    name="date"
                    defaultValue={loan.date ? new Date(loan.date).toISOString().split("T")[0] : new Date().toISOString().split("T")[0]}
                    required
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    name="interestRate"
                    step="0.01"
                    defaultValue={loan.interestRate ? Number(loan.interestRate) : undefined}
                    placeholder="0.00"
