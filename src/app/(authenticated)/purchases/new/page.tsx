        ...
        return (
            <div className="max-w-2xl mx-auto py-12">
                <Card className="text-center p-8 bg-white border border-slate-200 rounded-4xl shadow-xl">
                    ...
                    <Link href="/vendors" className="inline-flex justify-center items-center rounded-2xl bg-primary-600 px-6 py-3 text-sm font-black uppercase italic tracking-widest text-white shadow-xl shadow-primary-500/20 hover:bg-primary-500 transition-all">
                        Initialize Supplier
                    </Link>
                </Card>
            </div>
